...
public class UserForm {
    ...
    public static int echoChar;

    private boolean isValid;


    /**
     * This form is to show the login details
     * @param player
     */
    public UserForm(Player player) {
        //to check create echoChar for the password to display it in dots
        echoChar = passwordField1.getEchoChar();
        /**
         * enter button to switch to the GameForm
        ...
        enterButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                Player playerInfo = new Player(user);
                ...
                //this to check if the player exists
                    ...
                    else if (playerInfo== null&&pass.matches(specialChars)&&pass.matches(numbers)&&pass.matches(upperCaseChars)&& pass.length() > 8) {
                        openNext(player);
                    }
                }
        });
        ...
        /**
         * to clear everything as if it is just opened
         */
        clearButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                //to adjust the userTextfield back to null
                userTextField.setText(null);
                //to adjust the passwordField1 back to null
                passwordField1.setText(null);
            }
        });

        /**
         * a checkbox if it checcked woll show the password
         */
        showPasswordCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //if not then it will show the password in dots
                    ...
                    passwordField1.setEchoChar((char) echoChar);
                }
            }
        });
    ...
    public static void main(Player player) {
        ...
        frame.setContentPane(new UserForm(player).mainPanel);
    ...
    /**
     * to open the next form that GameForm
     * @param player
     */
